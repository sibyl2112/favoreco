...
> **最終更新**: 2026-07-09（カレンダー追加先選択方針追加）
...
- ジャンル別の初期有効ユニットは、観劇/ライブ=`基本情報`、`人物・団体`、`チケット・予定`、`写真`、`OCR・取込`、`金額`、`公式情報`、`メモ`。映画=`基本情報`、`人物・団体`、`写真`、`OCR・取込`、`公式情報`、`メモ`。本=`基本情報`、`人物・団体`、`写真`、`OCR・取込`、`メモ`。酒/御朱印=`基本情報`、`写真`、`OCR・取込`、`メモ`。テーマパーク/おでかけ施設=`基本情報`、`チケット・予定`、`写真`、`OCR・取込`、`金額`、`公式情報`、`メモ`。美術展は未確定で、作家/主催を重視するか、テーマパーク寄りに軽くするかを次に決める。
