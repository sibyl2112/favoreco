...
> **最終更新**: 2026-07-09（Mystorium課金モデル参照を追加）
...
- `NotificationSettingsView`: 通知設定。通知全体、申込開始/締切、当落、入金、発券、公演前日/当日、FC・会員期限、思い出リマインダーの入口を持つ。各通知は初期OFFで、ユーザーが必要なものを選ぶ。
...
- 通知は初期状態で勝手に鳴らさない。申込締切、当落、入金、発券、公演前日/当日、FC・会員期限、思い出リマインダーはすべてユーザーが選ぶ。iOS通知許可も起動直後には求めず、通知を有効化する操作やチケット/予定作成時に、用途を説明してから求める。
