...
- 月刊/年間Favorecoは、ローカル集計、カード候補、縦長カード画像の手動生成/共有、共有テキスト、クリップボードコピーまで実装済み。未実装範囲は自動生成/通知、期間切替、グラフ、予定/申込統計、Premium向け同期込み自動レポート。
