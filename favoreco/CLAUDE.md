...
- `StatsView`: SwiftDataのVisit/RecordCategoryから、総記録数、今年の記録、今月の記録、平均評価、ジャンル別回数、記録済み金額を表示する簡易統計タブ。金額はプライバシー情報として初期表示では伏せ、目アイコンを押した時だけ表示する。詳細統計、期間切替、年間まとめ、グラフ、予定/申込統計は未実装。
