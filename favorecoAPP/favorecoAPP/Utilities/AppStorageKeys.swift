...
enum AppStorageKeys {
    ...
    nonisolated static let automaticBackupEnabled = "automaticBackupEnabled"
    nonisolated static let automaticBackupLastCreatedAt = "automaticBackupLastCreatedAt"
    nonisolated static let automaticBackupUsesICloudDrive = "automaticBackupUsesICloudDrive"
    nonisolated static let automaticBackupLastICloudCreatedAt = "automaticBackupLastICloudCreatedAt"
    nonisolated static let automaticBackupICloudError = "automaticBackupICloudError"
    nonisolated static let automaticBackupLastAttemptAt = "automaticBackupLastAttemptAt"
    nonisolated static let automaticBackupLastResultStatus = "automaticBackupLastResultStatus"
    nonisolated static let automaticBackupLastResultMessage = "automaticBackupLastResultMessage"
    nonisolated static let automaticBackupLastResultPath = "automaticBackupLastResultPath"
    ...
    static let categoryPresetSeedVersion = "categoryPresetSeedVersion"
    static let personStarterPresetSeedVersion = "personStarterPresetSeedVersion"
    static let bundledTheaterSampleEyecatchRefreshVersion = "bundledTheaterSampleEyecatchRefreshVersion"
    static let ticketNotificationMetadataMigrationVersion = "ticketNotificationMetadataMigrationVersion"
