...
- 通知時刻はタイプ別に選べる。申込開始・当落発表・発券開始は`設定時刻どおり / 1時間前 / 前日20時`、申込締切・入金締切は`前日＋1時間前 / 前日のみ / 1時間前のみ`、公演は`前日20時＋当日9時 / 前日20時のみ / 当日9時のみ`、公演準備は`前日20時 / 1時間前 / 期限時刻どおり`とする。既定は順に設定時刻どおり、前日＋1時間前、前日20時＋当日9時、前日20時。
